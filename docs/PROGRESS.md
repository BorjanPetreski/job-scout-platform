...
> **NEXT: PHASE 2 — Fable 5 review gate (2.0), then Opus 4.8 build (2.1→2.11).** Phase 2 is fully
> planned (2026-07-15). The design contract (D1–D23), ordered checklist, and the model/effort handoff
> live in **[PHASE_2_PLAN.md](PHASE_2_PLAN.md)** — see **§12** for the pre-build review gate + per-step
> effort tiering. Do not re-open the settled decisions (D1–D23).
...
| # | Step | Status | Notes |
|---|------|--------|-------|
| 2.0 | Pre-build review gate (Fable 5, xhigh): scoped adversarial review of the plan; fix blocking findings before 2.1 | ⬜ | Plan §12.1 |
