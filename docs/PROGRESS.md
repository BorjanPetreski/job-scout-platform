...
| # | Step | Status | Notes |
|---|------|--------|-------|
| 2.0 | Pre-build review gate (Fable 5, xhigh): scoped adversarial review of the plan; fix blocking findings before 2.1 | ✅ 2026-07-16 | 4 blocking findings amended into the plan (catalog `status`/tier-coverage seam, enforcement wiring assigned to 2.1/2.2, floorless comp contract, `subvariant` marked NEW); 6 non-blocking recorded in plan §12.1 + the gate PR. D1–D23 intact |
